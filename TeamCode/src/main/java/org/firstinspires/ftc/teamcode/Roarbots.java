...
@Autonomous(name="Red Auto for Roarbots")
public class Roarbots extends Base{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rotOne.setPosition(0.0665);
        rotTwo.setPosition(0.0665);
...
//        kickerTwo.setPosition(KICKER_TWO_DOWN);
        ...
        rotOne.setPosition(0.063);
        rotTwo.setPosition(0.063);
