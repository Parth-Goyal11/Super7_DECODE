...
@Autonomous(name="Worlds Blue Double Dump 12")
public class WorldsBlueDoubleDump extends Base{
...
//        rotTwo.setPosition(0.165);
        ...
        gateTwo.addAll(
                new ArrayList<>(
                        Arrays.asList(
                                new Point(36, 29, 0, 0.8),
                                new Point(38, 23 , 0, 0.6),
                                new Point(48, 18, 0, 0.5 )
                        )
                )
        );
        ...
        rotOne.setPosition(0.565);
        rotTwo.setPosition(0.565);
...
//        sleep(380);
        backSweeper.setPower(0);
        frontSweeper.setPower(0);
        rotOne.setPosition(0.52);
        rotTwo.setPosition(0.52);
