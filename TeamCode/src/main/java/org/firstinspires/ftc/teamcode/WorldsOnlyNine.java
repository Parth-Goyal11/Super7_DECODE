...
@Autonomous(name="Worlds Double Dump Nine")
public class WorldsOnlyNine extends Base{

    ArrayList<Point> shot1, adjustShot, midIntake, sweepMid, firstIntake, gate, secondIntake, thirdIntake, park, bang1, bang2, shotBruh, sweepGate, moveGate, sweepGateTwo, moveGateTwo, intakeOne, finalIntake, intakeOneCheck, finalPark, gateTwo;
    int condition = 1;
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        rotOne.setPosition(0.5575);
        rotTwo.setPosition(0.5575);
...
//        rotTwo.setPosition(0.165);
        ...
        gate.addAll(
                new ArrayList<>(
                        Arrays.asList(
                                ...
                                new Point(48, 19 , 0, 0.6)
                        )
                )
        );

        gateTwo = new ArrayList<>();
        gateTwo.addAll(
                new ArrayList<>(
                        Arrays.asList(
                                new Point(30, 29, 0, 0.8),
                                new Point(48, 15 , 0, 0.6)
                        )
                )
        );
        ...
        rotOne.setPosition(0.47);
        rotTwo.setPosition(0.47);
        ...
        rotOne.setPosition(0.561);
        rotTwo.setPosition(0.561);
        backSweeper.setPower(0);
        frontSweeper.setPower(0);
        ChaseTheCarrotConstantHeadingWithShooter(gate, 9, 3, 0, 3, 1, 0.04, 0.04, 0.03, 0.0005, 0, 1200, 1);
...
//        kickThree = true;
        ...
        ChaseTheCarrotConstantHeading(gateTwo, 9, 3, 0, 3, 1, 0.05, 0.05, 0.03, 0.0005, 0.0005, 2500, 0.7);
...
//        sleep(380);
        backSweeper.setPower(0);
        frontSweeper.setPower(0);
        rotOne.setPosition(0.515);
        rotTwo.setPosition(0.515);
...
//
//        frontSweeper.setPower(0);
//        rotOne.setPosition(0.509);
//        rotTwo.setPosition(0.509);
//
//        backSweeper.setPower(0);
//
