...
public class Blue_Auto extends Base{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rotOne.setPosition(0.87);
        rotTwo.setPosition(0.87);
        ...
        firstIntake.addAll(
                new ArrayList<>(
                        Arrays.asList(
                                new Point(20, -47, 0, 0.8),
                                new Point(-12, -47, 0, 0.3)
                        )
                )
        );
        ...
        gate.addAll(
                new ArrayList<>(
                        Arrays.asList(
                                new Point(-0.5, -53.5, 0, 0.8),
                                new Point(-17.5, -58, 0, 0.8)
                        )
                )
        );
        ...
        secondIntake.addAll(
                new ArrayList<>(
                        Arrays.asList(
                                new Point(20, -70, 0, 0.8),
                                new Point(-22, -70, 0, 0.3)
                        )
                )
        );
