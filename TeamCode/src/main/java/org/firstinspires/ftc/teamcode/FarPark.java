...
public class FarPark extends Base{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rotOne.setPosition(0.423);
        rotTwo.setPosition(0.423);
...
//
//        frontSweeper.setPower(0);
//        rotOne.setPosition(0.505);
//        rotTwo.setPosition(0.505);
//
//        backSweeper.setPower(0);
//
