...
@Autonomous(name="Worlds Red Close 12")
public class WorldsRedAuto extends Base{
...
//        rotTwo.setPosition(0.165);
        ...
        rotOne.setPosition(0.463);
        rotTwo.setPosition(0.463);
...
//        sleep(380);
        backSweeper.setPower(0);
        frontSweeper.setPower(0);
        rotOne.setPosition(0.462);
        rotTwo.setPosition(0.462 );
...
//        Commented Out Worlds Auto - Last Spike Mark
//        backSweeper.setPower(1);
//
//
...
//
//        backSweeper.setPower(0);
//        rotOne.setPosition(0.4677);
//        rotTwo.setPosition(0.4677);
//
//        backSweeper.setPower(0);
//
